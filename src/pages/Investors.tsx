...
const Investors = () => {
  ...
  const handleDownloadPitch = () => {
    ...
    doc.text("ri@1001jobs.com.br", margin, H - 60);
    ...
    doc.text("ri@1001jobs.com.br", margin, y);
          ...
          <div className="container px-6 py-20 max-w-4xl">
            <div className="grid md:grid-cols-2 gap-12">
              <div>
                ...
                <a href="mailto:ri@1001jobs.com.br" className="inline-flex items-center gap-2 text-foreground font-medium hover:text-primary transition-colors">
                  <Mail className="w-4 h-4" /> ri@1001jobs.com.br <ArrowRight className="w-4 h-4" />
                </a>
              </div>
